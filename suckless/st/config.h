...
static char *font2[] = {
    /* Adwaita Mono: fills ~82% of the codepoints JetBrainsMono lacks -
       full polytonic Greek, all combining marks, math and box drawing. */
    "Adwaita Mono:pixelsize=11:antialias=true:autohint=true",
    /* Liberation Mono: the only installed monospace font with Hebrew
       letters plus niqqud/cantillation points. */
    "Liberation Mono:pixelsize=11:antialias=true:autohint=true",
